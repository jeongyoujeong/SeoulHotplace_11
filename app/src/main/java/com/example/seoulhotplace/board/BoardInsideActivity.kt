...
import com.example.seoulhotplace.comment.CommentListViewAdapter
import com.example.seoulhotplace.comment.CommentModel
import com.example.seoulhotplace.databinding.ActivityBoardInsideBinding
...
class BoardInsideActivity : AppCompatActivity() {
    ...
    fun insertcomment(key:String){
        ...
        Toast.makeText(this,"댓글입력완료",Toast.LENGTH_SHORT).show()
